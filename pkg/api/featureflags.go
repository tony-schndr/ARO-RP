...
const (
	...
	// FeatureFlagHyperthreadingModeDisabled is the feature in the subscription that is used to
	// Disable hyperthreading for compute nodes in the OpenShift Cluster
	FeatureFlagHyperthreadingModeDisabled = "Microsoft.RedHatOpenShift/HyperthreadingModeDisabled"
)
