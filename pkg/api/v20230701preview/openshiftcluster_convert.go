...
func (c openShiftClusterConverter) ToExternal(oc *api.OpenShiftCluster) interface{} {
		...
		Properties: OpenShiftClusterProperties{
			...
			NetworkProfile: NetworkProfile{
				...
				LoadbalancerProfile: LoadbalancerProfile{
					...
					OutboundRuleSNAT: oc.Properties.NetworkProfile.LoadbalancerProfile.OutboundRuleSNAT,
				},
			},
	...
	if oc.Properties.NetworkProfile.LoadbalancerProfile.EffectiveOutboundIPs != nil {
		...
		for _, p := range oc.Properties.NetworkProfile.LoadbalancerProfile.EffectiveOutboundIPs {
	...
	if oc.Properties.NetworkProfile.LoadbalancerProfile.OutboundIPs != nil {
		...
		for _, p := range oc.Properties.NetworkProfile.LoadbalancerProfile.OutboundIPs {
	...
	if oc.Properties.NetworkProfile.LoadbalancerProfile.OutboundIPPrefixes != nil {
		...
		for _, p := range oc.Properties.NetworkProfile.LoadbalancerProfile.OutboundIPPrefixes {
...
func (c openShiftClusterConverter) ToInternal(_oc interface{}, out *api.OpenShiftCluster) {
	...
	out.Properties.NetworkProfile.LoadbalancerProfile.OutboundRuleSNAT = oc.Properties.NetworkProfile.LoadbalancerProfile.OutboundRuleSNAT
	if oc.Properties.NetworkProfile.LoadbalancerProfile.OutboundIPs != nil {
